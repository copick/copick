...
![copick process hull input](../../assets/tools/process/hull-before.png)
...
<figure class="before-after__fig" markdown="span">
![copick process hull output](../../assets/tools/process/hull-after.png)
<figcaption>Output</figcaption>
</figure>

</div>

<p class="before-after__caption">Compute hull operations on meshes.</p>
