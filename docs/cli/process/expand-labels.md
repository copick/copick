...
![copick process expand-labels input](../../assets/tools/process/expand-labels-before.png)
...
<figure class="before-after__fig" markdown="span">
![copick process expand-labels output](../../assets/tools/process/expand-labels-after.png)
<figcaption>Output</figcaption>
</figure>

</div>

<p class="before-after__caption">Expand labels in segmentations to fill holes and gaps.</p>
