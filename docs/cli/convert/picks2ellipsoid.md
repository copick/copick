...
![copick convert picks2ellipsoid input](../../assets/tools/convert/picks2ellipsoid-before.png)
...
<figure class="before-after__fig" markdown="span">
![copick convert picks2ellipsoid output](../../assets/tools/convert/picks2ellipsoid-after.png)
<figcaption>Output</figcaption>
</figure>

</div>

<p class="before-after__caption">Convert picks to ellipsoid meshes.</p>
