...
![copick convert picks2mesh input](../../assets/tools/convert/picks2mesh-before.png)
...
<figure class="before-after__fig" markdown="span">
![copick convert picks2mesh output](../../assets/tools/convert/picks2mesh-after.png)
<figcaption>Output</figcaption>
</figure>

</div>

<p class="before-after__caption">Convert picks to meshes using convex hull or alpha shapes.</p>
